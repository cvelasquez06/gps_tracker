package cl.underline.gps_tracker.Services;
...
public class gpsTracker extends Service implements LocationListener {
        ...
        try {
            ...
            if (!isGPSEnabled && !isNetworkEnabled) {
                ...
                if (ActivityCompat.checkSelfPermission(this.mActivity, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
                        && ActivityCompat.checkSelfPermission(this.mActivity, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                    Toast.makeText(this.mContext, "PERMISSION ERROR", Toast.LENGTH_LONG).show();
                    return null;
                }
                if (isNetworkEnabled) {
    ...
    public void showSettingsAlert(){
        ...
        alertDialog.setTitle("GPS esta seteado");
